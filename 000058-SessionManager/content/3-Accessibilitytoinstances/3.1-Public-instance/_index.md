...
pre : " <b> 3.1. </b> "
---
![SSMPublicinstance](/Work-Shop/images/arc-02.png)
...
![Connect](/Work-Shop/images/3.connect/001-connect.png)
...
![Connect](/Work-Shop/images/3.connect/002-connect.png)


4. Then select **Public Linux Instance** and click **Start session** to access the instance.

![Connect](/Work-Shop/images/3.connect/003-connect.png)
...
![Connect](/Work-Shop/images/3.connect/004-connect.png)
